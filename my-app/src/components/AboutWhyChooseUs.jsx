...
export default function AboutWhyChooseUs({ setView }) {
  const cards = [
    {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center pb-16 border-b border-gray-200/60">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="space-y-2">
              <span className="text-[var(--color-brand-red)] font-extrabold text-xs uppercase tracking-widest block">
                WHY CHOOSE US
              </span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight font-outfit">
                What Makes Us <span className="text-[var(--color-brand-red)]">Different</span>
              </h2>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <a 
                ...
                className="bg-black hover:bg-gray-900 text-white font-bold text-xs uppercase tracking-wider px-8 py-3.5 rounded transition-all duration-300 flex items-center gap-2 group shadow-sm cursor-pointer"
              >
                Book Now 
